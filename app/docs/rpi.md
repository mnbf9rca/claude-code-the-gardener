...
```shell
DEBIAN_FRONTEND=noninteractive sudo apt-get install -y --no-install-recommends git jq libopencv-dev v4l-utils python3-numpy python3-pip python3-matplotlib acl
```
